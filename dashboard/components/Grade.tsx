    ...
    <div
      className={
        clicksCount == 2
          ? "hidden"
          : `relative group ${
              clicksCount == 1 ? "bg-red-400" : "bg-[#D9D9D9]"
            } w-[60px] h-[60px] text-4xl text-white flex justify-center items-center transition-[0.5s] ${
              clicksCount == 1 ? "hover:bg-red-300" : "hover:bg-[#b9b8b8]"
            }`
      }
      onClick={handleClick}
    >
      {clicksCount == 1 ? (
        <FaTrash className="w-[20px] h-[20px]" />
      ) : (
