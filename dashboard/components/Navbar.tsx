  ...
  return (
    <Box sx={{ display: 'flex', overflow: 'hidden' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <Divider />
        <List>
          <MenuOption open={open} text={"Home"} icon={<AiFillHome className='w-[20px] h-[20px]' />} />
          <MenuOption open={open} text={"Annoucements"} icon={<TfiAnnouncement className='w-[20px] h-[20px]' />} />
          <MenuOption open={open} text={"Manage Students"} icon={<BsFillPersonFill className='w-[20px] h-[20px]' />} />
        </List>
        <Divider />
      </Drawer>
